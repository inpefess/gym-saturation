...
class TPTPParser:
    ...
    ...     Function, new_clause)
    >>> clause = new_clause(literals=(Literal(True, Predicate("=", (Function("this_is_a_test_case", (Variable("X"), )), Variable("Y")))),), inference_rule="resolution", inference_parents=("one", "two"))
